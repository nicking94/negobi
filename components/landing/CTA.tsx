  ...
  return (
    <section className="relative py-20 px-4 bg-white text-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -right-20 w-40 h-40 rounded-full bg-green_b"></div>
        <div className="absolute -top-20 -left-20 w-40 h-40 rounded-full bg-green_b"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button
            variant={"default"}
            className="text-white transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            <a
              href={
